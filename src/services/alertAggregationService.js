...
import { AlertEmployee, AlertsSummary, BenefitPlan, EmployeeBenefit } from "../models/sql/index.js";
...
const flushEmployeeBatch = async (rows) => {
    if (!Array.isArray(rows) || rows.length === 0) return;
    await AlertEmployee.bulkCreate(rows);
};
